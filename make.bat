...
SETLOCAL
SET PROJECT_DIR=%cd%
SET PROJECT_NAME=census-data-examples
SET SUPPORT_LIBRARY = census_data
SET ENV_NAME=census-data
...
:build_upload
    ENDLOCAL & (
        ...
        :: Build conda package
        CALL conda build ./conda-recipe --output-folder ./conda-recipe/conda-build
        CALL anaconda upload ./conda-recipe/conda-build/win-64/census-data-examples*.tar.bz2
